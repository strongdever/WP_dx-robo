    ...
    <main id="single-blog">
        <div class="bread-crump">
            <div class="container">
                ...
                <i class="fas fa-chevron-right"></i>
                <h5 class="current-page"><?php echo get_field('name'); ?></h5>
            </div>
        </div>
        ...
        <section class="blog-pannel">
            <div class="container">
                <ul class="blog-list">
                    <li class="blog-item">
                        ...
                        <div class="career-wrapper">
                            ...
                            <p class="desc-15-normal"><?php echo wp_kses_post ( get_field('career') ); ?></p>
                        </div>
                        ...
                        <div class="qualification-wrapper">
                            ...
                            <ul class="qualification-list desc-15-normal">
                                <?php while( have_rows('qualification-list') ): the_row(); ?>
                                <?php if( get_sub_field('qualification') ) : ?>
                                <li class="qualification-item"><?php the_sub_field('qualification'); ?></li>
                                <?php endif; ?>
                                <?php endwhile; ?>
                            </ul>
                        </div>
                ...
                <a class="goto-page desc-15-bold" href="<?php echo HOME . "search"; ?>"><i class="fa-solid fa-arrow-right"></i>全国のRPA導入士一覧に戻る</a>
            </div>
        </section>
    </main>
