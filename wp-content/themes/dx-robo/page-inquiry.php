...
<script type="text/javascript">
    !(function ($) {
        ...
        $(document).ready(function () {
            var purpose = localStorage.getItem('purpose_param');
            var name = localStorage.getItem('name_param');
            if ( purpose != '' ) {
                $('#purpose').val(purpose);
            }
            if ( name != '' ) {
            ...
            localStorage.setItem('purpose_param', '');
            localStorage.setItem('name_param', '');
        });
    })(jQuery);
</script>
